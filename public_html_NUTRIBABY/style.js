...
var resetLink = function () {
    ...
    if (n && n.attr("lp-id-pop-sub") && n.attr("lp-id-pop-sub").length > 0) {
        ...
        if (n.attr("lp-ss-f") && n.attr("lp-ss-f").length > 0) {
            ...
            r && r.length > 0 && (o += "&utm_source=" + r), l && l.length > 0 && (o += "&utm_medium=" + l), s && s.length > 0 && (o += "&utm_campaign=" + s), p && p.length > 0 && (o += "&utm_term=" + p), c && c.length > 0 && (o += "&utm_content=" + c);
...
function showWatermark(t) {
    if ("1" == t) {
        ...
        //     $("body").find(".lp-watermart").length > 0 || ($("body").append('<div class="lp-watermart" style="background: #EAEBEE;display: block!important;position: fixed;bottom: 0px;left: 0px;width: 100%; height: 32px;z-index: 9999999999; text-align: center"><a style="width: 100%; height: 100%; display: inline-block;" href="https://ladipage.vn/?utm_source=freemium" target="_blank" rel="nofollow"><img src="./images/ladipage.png"></a></div>'), $("body").css({"margin-bottom": "32px!important"}));
...
function ladinotify() {
    ...
    (t = jQuery).fn.ladiNotify = function (e) {
        var i = t.extend({showDuration: 4e3, hideDuration: 6e3}, e),
            n = "./images/notify.svg", a = [{key: "gsx$title", className: ".nttitle"}, {
                key: "gsx$content",
                className: ".ntcontent"
