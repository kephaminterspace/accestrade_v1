...
var checkForm = {countForm: 0, countTo: 0, value: "false"}, runSlider, timeoutSlider, leftchange = 1,
    ...
    isChrome = !!window.chrome && !!window.chrome.webstore, checkios = function () {
        var t = navigator.userAgent, e = /iPad|iPhone|iPod/.test(t), i = /OS 11_0|OS 11_1|OS 11_2/.test(t);
        return e && i ? "true" : "false"
    }, ios = checkios(), scrollTop = 0, showpop = {loadpage: 0, outpage: 0, idSroll: []},
...
var resetLink = function () {
    ...
    if (t && t.length > 0) {
        ...
        t.each(function () {
            e = $(this).find(".container").eq(0).outerHeight(), (i = (n - e) / 2) < 40 && (i = 40), $(this).find(".container").eq(0).css({top: i + "px"})
        })
    }
}, getUtm = function (t) {
    ...
    if ($(t) && $(t).length > 0 && "phone" == $(t).attr("name")) {
        var i = $(t).val();
        if ($(".formHintBubble").remove(), 10 == i.length || 11 == i.length) if (10 == (i = i.replace(/[^0-9]/g, "")).length || 11 == i.length) ; else {
            var n = $(t).parent().parent(), a = parseFloat($(t).parent().css("top")) - 35,
                o = $("<span/>").html('<span class="formHintBubble" style="top: ' + a + 'px;">KhÃ´ng pháº£i sá»‘ Ä‘iá»‡n thoáº¡i</span>').contents();
            n.append(o), $(t).val(i), e = !1
        } else {
            n = $(t).parent().parent(), a = parseFloat($(t).parent().css("top")) - 35, o = $("<span/>").html('<span class="formHintBubble" style="top: ' + a + 'px;">KhÃ´ng pháº£i sá»‘ Ä‘iá»‡n thoáº¡i</span>').contents();
            n.append(o), $(t).val(i), e = !1
        }
    }
    return e
    ...
    t && t.length > 0 && 0 == showpop.loadpage && (t.each(function () {
        var t = $(this).attr("lp-delay-show-popup-page"), e = $(this).attr("lp-show-popup-page"), i = $(this);
        if (e && "1" == e) {
            var n = 0;
    ...
    if (t && t.length > 0) {
        var e = t.attr("lp-action-type"), i = t.attr("lp-action-link"), n = document.createElement("a");
        ...
        switch (e) {
            ...
            case"page":
                i = "#" + i;
                var o = $(i).offset().top;
                $("body,html").animate({scrollTop: o}, 1e3);
                break;
            case"url":
    ...
    if (n && n.attr("lp-id-pop-sub") && n.attr("lp-id-pop-sub").length > 0) {
        ...
        var a = $("#" + n.attr("lp-id-pop-sub"));
        a.find(".container").find(".closePop").remove(), a.find(".container").find(".iframeTks").remove(), a.find(".container").eq(0).append('<div class="closePop" style="top:-25px; right:0;">X</div>'), a.removeClass("lp-hidepopup"), a.addClass("lp-showpopup"), a.css({
            display: "block",
            position: "fixed"
        }), a.removeClass("lazy-hidden"), a.find(".lazy-hidden").removeClass("lazy-hidden"), resetTopPopup(), -1 == a.css("display").search("none") && (scrollTop = $(window).scrollTop(), "true" == ios && $("body").addClass("body-fixed")), runtrackingCus(a), a.find(".closePop").unbind("click").click(function () {
            $("body").removeClass("body-fixed"), $(window).scrollTop(scrollTop), $(this).parent().parent().removeClass("lp-showpopup").hide(), $(this).parent().parent().addClass("lp-hidepopup").hide();
            var t = $(this).parent().parent().find('.widget-element[lp-type="videoyoutube"] .widget-content:eq(0)');
            t && t.length > 0 && t.each(function () {
                var t = $(this).attr("src");
        ...
        if (n.attr("lp-ss-f") && n.attr("lp-ss-f").length > 0) {
            var r = getUtm("utm_source"), l = getUtm("utm_medium"), s = getUtm("utm_campaign"), p = getUtm("utm_term"),
                c = getUtm("utm_content");
            r && r.length > 0 && (o += "&utm_source=" + r), l && l.length > 0 && (o += "&utm_medium=" + l), s && s.length > 0 && (o += "&utm_name=" + s), p && p.length > 0 && (o += "&utm_term=" + p), c && c.length > 0 && (o += "&utm_content=" + c);
            n.find(".widget-element .widget-content");
            if (o && o.length > 0) {
                var d = "?", h = n.attr("lp-id-pop-url").split("/");
                "?" == h[h.length - 1][0] && (d = "&"), o && o.length > 0 && (o = d + o.slice(1, o.length))
            }
        }
        var u = n.attr("lp-id-pop-url") + o;
        window.location.href = u
    } else {
        $(".popup.ladi-popup-form").hide(), $('.widget-section[lp-popup="true"]').hide();
        var g = "";
        g += '<div class="popup ladi-popup-form" data-form="' + e + '" style="display:none;"> <div class="popup-dialog bounceIn animated" style="display: none;"> <div class="popup-header">', g += '<h3 class="popup-title">ThÃ´ng bÃ¡o </h3> <button class="close-popup">x</button>', g += '</div> <div class="popup-content">' + i + "</div> </div> </div>", $("body").append(g), $(".ladi-popup-form").show(), $(".ladi-popup-form").css({position: "fixed"}), $(".ladi-popup-form .popup-dialog").show(), $(".close-popup").click(function () {
...
function endTime(t) {
    var e = Date.parse(t) - Date.parse(new Date), i = Math.floor(e / 1e3 % 60), n = Math.floor(e / 1e3 / 60 % 60),
        a = Math.floor(e / 36e5 % 24);
    return {t: e, d: Math.floor(e / 864e5), h: a, m: n, s: i}
}

function countDown(t, e) {
    var i = t.find("div > span"), n = i.eq(0), a = i.eq(1), o = i.eq(2), r = i.eq(3);

    function l() {
        var i = endTime(e);
        i.t > 0 ? (n.text(i.d), a.text(i.h), o.text(i.m), r.text(i.s)) : (n.text("00"), a.text("00"), o.text("00"), r.text("00"), clearInterval(s), $(t.attr("lp-show")).addClass("animated fadeInDown").css({display: "block"}))
    }
...
function showWatermark(t) {
    if ("1" == t) {
        setInterval(function () {
            $("body").find(".lp-watermart").length > 0 || ($("body").append('<div class="lp-watermart" style="background: #EAEBEE;display: block!important;position: fixed;bottom: 0px;left: 0px;width: 100%; height: 32px;z-index: 9999999999; text-align: center"><a style="width: 100%; height: 100%; display: inline-block;" href="https://ladipage.vn/?utm_source=freemium" target="_blank" rel="nofollow"><img src="https://static.ladipage.net/source/ladipage.png"></a></div>'), $("body").css({"margin-bottom": "32px!important"}));
            for (var t = document.getElementsByTagName("link"), e = 0, i = 0; i < t.length; i++) "image/ico" == t[i].type && "shortcut icon" == t[i].rel && (t[i].href = "https://static.ladipage.net/favicon.ico", e = 1);
            0 == e && $("head").append('<link rel="shortcut icon" type="image/ico" href="https://static.ladipage.net/favicon.ico">')
        }, 2e3)
    }
}
...
function accountFree() {
    ...
    // -1 != t.search("ladipage.me") ? showWatermark("1") : $.ajax({
    //     type: "POST",
...
GoogleMap.prototype.init = function () {
    var t = this, e = $('.widget-element[lp-type="googlemap"]');
    e.length > 0 && e.each(function () {
        var e = $(this).find(".widget-content").eq(0)[0], i = parseFloat($(this).attr("lp-mapzoom")),
            n = $(this).attr("lp-mapaddress"), a = $(this).attr("lp-maptitletext"),
            o = $(this).attr("lp-maptitleimage");
        void 0 != o && "" != o && (a = '<div class="lp-maptitle"><p><img src="' + o + '"></p><p>' + a + "</p></div>"), t.createMaps(e, i, n, a)
    })
}, GoogleMap.prototype.createMaps = function (t, e, i, n) {
    window.google = window.google || {}, google.maps = google.maps || {}, google && (new google.maps.Geocoder).geocode({address: i}, function (i, a) {
        if (a == google.maps.GeocoderStatus.OK) {
            var o = new google.maps.Map(t, {zoom: e, center: i[0].geometry.location}),
                r = new google.maps.Marker({map: o, position: i[0].geometry.location});
            new google.maps.InfoWindow({content: n}).open(o, r)
        }
    })
};
...
LightBox.prototype.init = function () {
    var t = $("[lp-lightbox]");
    void 0 != t && t.length > 0 && t.unbind("click").click(function () {
        var t = $(this).attr("lp-lightbox");
        if (void 0 != t && "undefined" != t && "" != t && $("#" + t).length > 0) {
            var e = $("#" + t);
            if (void 0 != e && e.length > 0) {
                var i = "", n = ($(window).outerHeight() - 600) / 2, a = 600;
                n < 0 && (n = 0, a = $(window).outerHeight()), i = i + '<div class="lp-popup-pub lightbox-image" style="position: fixed;"><div class="container animated fadeIn" style="display:none;"><div class="closePop" style="top:' + (n - 12) + 'px!important;left: -12px!important; padding:0px; padding-left: 6px;">X</div>' + e[0].outerHTML + "</div></div>", $("body").append(i), $(".lightbox-image #" + t).css({
                    ...
                    left: "0px",
                    top: n + "px"
                }), $(".lightbox-image .container").css({background: "rgba(0,0,0,0)"}), $(".lightbox-image").css({background: "rgba(0,0,0,0.5)"}), $(".lightbox-image #" + t).parent().show(), $(".lightbox-image #" + t).parent().css({position: "fixed"}), $(".lightbox-image .closePop").click(function () {
...
slider.prototype.playAllSlider = function () {
    var t = this;
    $('.widget-element[lp-type="slider"]').each(function () {
        t.playSlider($(this))
    })
}, slider.prototype.playSlider = function (t) {
    var e = t.find('.widget-element[lp-type="item_slider"]');
    if (e && e.length > 0) {
        var i = parseFloat(e.eq(0).css("width")), n = parseFloat(t.attr("lp-delay"));
        n && n > 0 || (n = 5e3), runSlider = setInterval(function () {
            if (t.find('.widget-element[lp-type="item_slider"]').css({width: t.css("width")}), t.find(".wrap-child") && t.find(".wrap-child").length > 0) {
                var n = t.find(".wrap-child").eq(0);
                n.finish();
                var a = t.outerWidth(), o = parseFloat(n.css("left"));
                if ((l = t.find('.wrap-child .widget-element[lp-type="item_slider"]:last')).offset().left > t.offset().left) {
                    var r = Math.round((0 - o) / t.outerWidth());
                    o = r < t.find('.widget-element[lp-type="item_slider"]').length - 1 ? o - a + "px" : "0px"
                } else o = "0px";
                n.animate({left: o})
            } else {
                var l = t.find('.widget-element[lp-type="item_slider"]:last');
                if (parseFloat(l.css("left")) + i > parseFloat(t.css("width"))) e.each(function () {
                    $(this).finish(), o = parseFloat($(this).css("left")) - i, $(this).animate({left: o + "px"}), widthWindow <= 768 && Math.round(o) > 10 ? $(this).hide() : $(this).show()
                }); else {
                    var s = 0;
                    e.each(function () {
                        $(this).finish(), o = s * i, $(this).animate({left: o + "px"}), widthWindow <= 768 && Math.round(o) > 10 ? $(this).hide() : $(this).show(), s++
                    })
                }
            }
        }, n);
        var a = t.attr("lp-autoPlay");
        a && a.length > 0 && "1" == a || clearInterval(runSlider)
    }
}, slider.prototype.playSliderControl = function () {
    $(".control-slider-right").unbind("click").click(function (t) {
        t.preventDefault();
        var e = $(this).parent().parent();
        if (e && "slider" == e.attr("lp-type")) {
            var i = e.find('.widget-element[lp-type="item_slider"]');
            if (i && i.length > 0) if (i.css({width: e.css("width")}), e.find(".wrap-child") && e.find(".wrap-child").length > 0) {
                var n = e.find(".wrap-child").eq(0);
                n.finish();
                var a = e.outerWidth(), o = parseFloat(n.css("left"));
                if ((r = e.find('.wrap-child .widget-element[lp-type="item_slider"]:last')).offset().left > e.offset().left) o = Math.round((0 - o) / e.outerWidth()) < e.find('.widget-element[lp-type="item_slider"]').length - 1 ? o - a + "px" : "0px"; else o = "0px";
                n.animate({left: o})
            } else {
                var r = e.find('.widget-element[lp-type="item_slider"]:last');
                if (Math.abs(parseFloat(r.css("left")) + parseFloat(r.css("width")) - parseFloat(e.css("width"))) > 10 || widthWindow <= 768) if (widthWindow <= 768) {
                    var l = 0;
                    i.each(function (t) {
                        $(this).finish(), "none" != $(this).css("display") && (l = t)
                    });
                    var s = i.eq(l);
                    if (l < i.length - 1) {
                        i.css({left: "0px"}).hide();
                        var p = s.next();
                        p.css({left: p.css("width")}), s.animate({left: 0 - parseFloat(s.outerWidth()) + "px"}).show(), p.animate({left: "0px"}).show(), s.fadeOut("slow")
                    }
    ...
    }), $(".control-slider-left").unbind("click").click(function (t) {
        t.preventDefault();
        var e = $(this).parent().parent();
        if (e && "slider" == e.attr("lp-type")) {
            var i = e.find('.widget-element[lp-type="item_slider"]');
            if (i.css({width: e.css("width")}), i && i.length > 0) if (e.find(".wrap-child") && e.find(".wrap-child").length > 0) {
                var n = e.find(".wrap-child").eq(0);
                n.finish();
                var a = e.outerWidth(), o = parseFloat(n.css("left"));
                o = e.find('.wrap-child .widget-element[lp-type="item_slider"]:eq(0)').offset().left < e.offset().left ? o + a + "px" : "0px", n.animate({left: o})
            } else {
                e.find('.widget-element[lp-type="item_slider"]:last');
                if (parseFloat(i.eq(0).css("left")) < -10 || widthWindow <= 768) if (widthWindow <= 768) {
                    var r = 0;
                    i.each(function (t) {
                        $(this).finish(), "none" != $(this).css("display") && (r = t)
                    });
                    var l = i.eq(r);
                    if (r > 0) {
                        i.css({left: "0px"}).hide();
                        var s = l.prev();
                        s.css({left: 0 - parseFloat(l.outerWidth()) + "px"}), l.animate({left: parseFloat(l.outerWidth()) + "px"}).show(), s.animate({left: "0px"}).show(), l.fadeOut("slow")
                    }
                } else i.each(function () {
                    $(this).finish(), $(this).animate({left: parseFloat($(this).css("left")) + parseFloat($(this).css("width")) + "px"});
...
var AjaxForm = function () {
    ...
    var r = getUtm("utm_source"), l = getUtm("utm_medium"), s = getUtm("utm_campaign"), p = getUtm("utm_term"),
        c = getUtm("utm_content"), d = {name: "url_page", value: window.location.href};
    a.push(d), d = {name: "utm_source", value: r}, a.push(d), d = {
        name: "utm_medium",
        value: l
    }, a.push(d), d = {name: "utm_campaign", value: s}, a.push(d), d = {
        name: "utm_term",
        value: p
    }, a.push(d), d = {name: "utm_content", value: c}, a.push(d), n && n.length > 0 && $.ajax({
        type: "POST",
    ...
    if (n && n.length > 0) {
        ...
        for (var a = 0; a < n.length; a++) switch (n[a].Type) {
            case"api":
                ...
                break;
            case"google-form":
                var o = n[a].Fvv, r = n[a].DraftResponse, l = n[a].PageHistory, s = n[a].Fbzx, p = n[a].Action;
                sendFormClientGoogleForm(t, n[a].List, o, r, l, s, p)
        }
    }
}, sendFormClientApi = function (t, e, i) {
    for (var n = {}, a = 0; a < e.length; a++) e[a].idName ? n[e[a].idName] = e[a].value : n[e[a].key] = e[a].value;
    var o = getUtm("utm_source"), r = getUtm("utm_medium"), l = getUtm("utm_campaign"), s = getUtm("utm_term"),
        p = getUtm("utm_content"), c = window.location.href;
    n.link = c, o && o.length > 0 && (n.utm_source = o), r && r.length > 0 && (n.utm_medium = r), l && l.length > 0 && (n.utm_campaign = l), s && s.length > 0 && (n.utm_term = s), p && p.length > 0 && (n.utm_content = p), $.ajax({
        type: "POST",
        url: i,
    ...
    if (l.fvv = i, l.draftResponse = n, l.pageHistory = a, l.fbzx = o, e && e.length > 0) {
        for (var p = 0; p < e.length; p++) s += $("#" + e[p].id).find(".widget-content").eq(0).val(), l[e[p].idGoogleForm] = $("#" + e[p].id).find(".widget-content").eq(0).val();
        if (s) (new AjaxForm).senForm(l, t, r); else popupForm("Vui lÃ²ng Ä‘iá»n thÃ´ng tin khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng!", "ladi-check-value")
    }
};
AjaxForm.prototype.sendValue = function (t, e, i, n, a) {
    var o = t.attr("lp-type-form"), r = $('.widget-element[lp-parent="' + t.attr("id") + '"]'),
        l = r.find(".widget-content").eq(0).html();
    if (r.attr("lp-value-text", l), r.find(".widget-content").eq(0).text("Vui lÃ²ng Ä‘á»£i"), t.attr("id-conf-sv") && t.attr("id-conf-sv").length > 0 || t.attr("lp-config-client") && t.attr("lp-config-client").length > 0) t.attr("id-conf-sv") && t.attr("id-conf-sv").length > 0 && (checkForm.countForm++, sendFormServer(t, n, i)), t.attr("lp-config-client") && t.attr("lp-config-client").length > 0 && (checkForm.countForm++, sendFormClient(t, n, i)); else if (t.attr("lp-action") && t.attr("lp-action").length > 0) switch (o) {
        case"pc":
    ...
    setTimeout(function () {
        ...
        e && e.length > 0 && (e.css({"pointer-events": "auto"}), e.find(".widget-content").eq(0).html(r.attr("lp-value-text")))
    }, 3e3);
    var p = setInterval(function () {
        if (checkForm.countTo == checkForm.countForm && 0 != checkForm.countForm) {
            var e;
            if (clearInterval(p), "true" == checkForm.value) runtrackingCus(t), runTrackingForm(t), popupForm(t.attr("lp-message-form"), t.attr("id")), t.find(".widget-element .widget-content").val(""), (e = $('.widget-element[lp-parent="' + t.attr("id") + '"]')).find(".widget-content").eq(0).html(e.attr("lp-value-text")); else popupForm("ÄÃ£ xáº£y ra lá»—i, vui lÃ²ng kiá»ƒm tra láº¡i! Hoáº·c liÃªn há»‡ vá»›i chÃºng tÃ´i Ä‘á»ƒ Ä‘Æ°á»£c há»— trá»£!", t.attr("id")), t.find(".widget-element .widget-content").val(""), (e = $('.widget-element[lp-parent="' + t.attr("id") + '"]')).find(".widget-content").eq(0).html(e.attr("lp-value-text"));
    ...
    for (var e = t.find(".widget-content:eq(0) .widget-element"), i = {}, n = JSON.parse(t.attr("lp-data-form")), a = 0; a < n.length; a++) e.each(function (t) {
        if (n[a].name == $(this).find(".widget-content").eq(0).attr("name")) if ($(this).find(".widget-content").eq(0).attr("lp-name-id") && $(this).find(".widget-content").eq(0).attr("lp-name-id").length > 0) {
    ...
    var o = getUtm("utm_source"), r = getUtm("utm_medium"), l = getUtm("utm_campaign"), s = getUtm("utm_term"),
        p = getUtm("utm_content"), c = window.location.href;
    o && o.length > 0 && (i.utm_source = o), r && r.length > 0 && (i.utm_medium = r), l && l.length > 0 && (i.utm_campaign = l), s && s.length > 0 && (i.utm_term = s), p && p.length > 0 && (i.utm_content = p), i.link = c;
    var d = t.attr("lp-action");
    $.ajax({
        type: "POST", url: d, contentType: "application/x-www-form-urlencoded", data: i, success: function (t) {
    ...
    var e = t.find(".widget-content:eq(0) .widget-element"), i = [], n = t.attr("lp-action");
    if (n && n.length > 0) {
        ...
        })), t.attr("lp-vt-item") && t.attr("lp-vt-item").length > 0) ; else for (var a = 0; a < i.length; a++) for (var o = 0; o < i.length; o++) if (i[a].top < i[o].top) {
            var r = {};
        ...
        var l = getUtm("utm_source"), s = getUtm("utm_medium"), p = getUtm("utm_campaign"), c = getUtm("utm_term"),
            d = getUtm("utm_content"), h = {name: "url page", value: window.location.href};
        i.push(h), h = {name: "utm_source", value: l}, i.push(h), h = {
            name: "utm_medium",
            value: s
        }, i.push(h), h = {name: "utm_campaign", value: p}, i.push(h), h = {
            name: "utm_term",
            value: c
        }, i.push(h), h = {name: "utm_content", value: d}, i.push(h), i && i.length > 0 && $.ajax({
            type: "POST",
            url: "https://api.ladipage.vn/v1/app/sendInfoForm",
            data: {id: n, dataForm: i},
            success: function (t) {
                checkForm.countTo++, checkForm.value = "true"
            },
            error: function (t) {
    ...
    t.attr("lp-action");
    var e, i = JSON.parse(t.attr("lp-data-form")), n = t.find(".widget-content:eq(0) .widget-element"), a = {}, o = "";
    (e = i.itemsSave && i.itemsSave.length > 0 ? i.itemsSave : i.items) && e.length > 0 ? (n.each(function (t) {
        for (var i = 0; i < e.length; i++) if (o += $(this).find(".widget-content").eq(0).val(), $(this).find(".widget-content").eq(0).attr("name") == e[i].nameFormUser) {
    ...
    var e = {};
    t.find(".widget-content:eq(0) .widget-element").each(function () {
        e[$(this).find(".widget-content").eq(0).attr("name")] = $(this).find(".widget-content").eq(0).val()
    });
    var i = t.attr("lp-action");
    this.senForm(e, t, i)
}, AjaxForm.prototype.saveFormPc = function (t, e, i, n, a) {
    var o = {formid: e, listcontact: i, ladipageid: n, name: a};
    this.senForm(o, t, "https://builder.ladipage.vn/api/index.php/Formdata/updateform")
}, AjaxForm.prototype.email = function (t) {
    var e = {}, i = "", n = "";
    t.find(".widget-content:eq(0) .widget-element").each(function () {
        $(this).find(".widget-content").eq(0).attr("lp-label") ? (i = i + "" + $(this).find(".widget-content").eq(0).attr("lp-label") + ": " + $(this).find(".widget-content").eq(0).val() + "<br>", e[$(this).find(".widget-content").eq(0).attr("lp-label")] = $(this).find(".widget-content").eq(0).val()) : (i = i + "" + $(this).find(".widget-content").eq(0).attr("name") + ": " + $(this).find(".widget-content").eq(0).val() + "<br>", e[$(this).find(".widget-content").eq(0).attr("name")] = $(this).find(".widget-content").eq(0).val()), n += $(this).find(".widget-content").eq(0).val()
    });
    var a = t.attr("lp-action"), o = {
        from: '"Ladipage" <no-reply@ladipage.vn>',
        to: a,
        subject: "ThÃ´ng bÃ¡o dá»¯ liá»‡u tá»«: " + window.location.href,
        text: "Dá»¯ liá»‡u:",
        html: i + "<br>Dá»¯ liá»‡u tá»«: " + window.location.href,
        id: $("head .title-site").attr("lp-id")
    };
    a && a.length > 0 && -1 != a.search("https://docs.google.com/forms") || a && a.length > 0 && -1 != a.search("https://goo.gl/forms") ? this.google(t) : n ? $.ajax({
        type: "POST",
    ...
    n ? $.ajax({
        type: "POST", url: "https://api.ladipage.vn/v1/app/sendMail", data: a, success: function (t) {
            checkForm.countTo++, 200 == t.code && (checkForm.value = "true")
        }, error: function (t) {
            checkForm.countTo++
        }
...
ReponsivePage.prototype.init = function () {
    if ((t = $("#lp-viewport")) && t.length > 0) ; else {
        var t, e = parseFloat($(window).outerWidth()),
            i = "width=device-width, initial-scale=1.0, maximum-scale=1.0,minimum-scale=1.0", n = 1;
        e <= 767 ? i = "width=375, initial-scale=" + (n = e / 375) : n < 960 && (i = "width=960, initial-scale=" + (n = e / 960)), (t = $('head meta[name="viewport"]')).attr("content", i)
    }
};
var runtrackingCus = function (ele) {
    if (ele && ele.length > 0) {
        ...
        if (ele.attr("lp-traking-cus") && ele.attr("lp-traking-cus").length > 0) {
            ...
            json.pixel && "true" == json.pixel && json.nameEventTK && json.nameEventTK.length > 0 && (tracking += "fbq('trackCustom', '" + json.nameEventTK + "');"), json.idgAds && "true" == json.idgAds && json.IdEventTK && json.IdEventTK.length > 0 && json.LabelEventTK && json.LabelEventTK.length > 0 && (tracking += "gtag('event', 'conversion', {'send_to': 'AW-" + json.IdEventTK + "/" + json.LabelEventTK + "'});"), json.idgAny && "true" == json.idgAny && json.nameEventTK && json.nameEventTK.length > 0 && (tracking += "gtag('event', '" + json.nameEventTK + "', {'event_category': 'LadiPageClick','event_label': '" + window.location.host + window.location.pathname + "'});"), tracking && tracking.length > 0 && (console.log("rung"), eval(tracking))
        }
    ...
    1 != e && $(window).outerWidth() < 768 && $(".widget-content").each(function () {
        var t = parseFloat($(this).css("font-size")), i = parseFloat($(this).css("line-height")),
            n = parseFloat(t * e * e).toFixed(4), a = parseFloat(i * e * e).toFixed(4);
    ...
    if (ev.preventDefault(), ev.stopPropagation(), "button" == $(ele).attr("lp-type") && $(ele).attr("lp-parent") && $(ele).attr("lp-parent").length > 0) if ($(ele).css({"pointer-events": "none"}), checkForm.countForm != checkForm.countTo) ; else {
        ...
        if (inputRequired && inputRequired.length > 0) inputRequired.each(function (t) {
            if (!this.validity.valid) {
                ...
                var e = formTarget.find(".widget-content:eq(0)"), i = $(this), n = i.get(0),
                    a = (i.position(), n.validationMessage || "Invalid value."),
                    o = parseFloat($(this).parent().css("top")) - 35, r = $(this).parent().css("left"),
                    l = $(this).parent().css("width"),
                    s = $("<span/>").html('<span class="formHintBubble" style="top: ' + o + "px;left:" + r + ";width:" + l + ';">' + a + "</span>").contents();
                return e.append(s), $(ele).css({"pointer-events": "auto"}), !1
            }
...
}, arrClassSectionAnimate = [], checkId = function (t, e) {
    if (t && t.length > 0) for (var i = 0; i < t.length; i++) if (t[i].id == e) return e;
    return !1
}, runAnimateSection = function () {
    var t = $('.widget-section.animated[lp-popup!="true"]');
    if (t && t.length > 0) {
        var e = $(window).scrollTop(), i = $(window).outerHeight();
        t.each(function () {
    ...
    var t = $(window).scrollTop(), e = $(".widget-section:visible"), i = $('.widget-section[lp-popup="true"]:visible');
    if (i && i.length > 0) ; else {
        var n = $(window).outerHeight();
        e.each(function () {
            var e = $(this).find(".animated");
            e && e.length > 0 && -1 == $.inArray($(this).attr("id"), LP_DOC.arrAnimate) && e.each(function () {
                var e = $(this).offset().top, i = $(this).outerHeight();
                -1 == $.inArray($(this).attr("id"), LP_DOC.arrAnimate) && (e + i < t || e > t + n || ($(this).hide(), "fixed" != $(this).css("position") && $(this).hasClass("widget-element") && "true" == $(this).attr("lp-popup") || $(this).show(), LP_DOC.arrAnimate.push($(this).attr("id"))))
            })
        });
        var a = $('[lp-ani!=""]');
        a && a.length > 0 && a.each(function () {
            ...
            if (e && e.length > 0) {
                var i = $(this).offset().top, a = $(this).outerHeight();
                -1 == $.inArray($(this).attr("id"), LP_DOC.arrAnimate) && (i + a < t || i > t + n || ("fixed" != $(this).css("position") && $(this).hasClass("widget-element") && "true" == $(this).attr("lp-popup") || $(this).addClass(e), LP_DOC.arrAnimate.push($(this).attr("id"))))
            }
        }), stickyRun()
    }
}, trackingScroll = [];
LadiApp.prototype.init = function () {
    ...
    if (t && t.length > 0) {
        ...
        t.each(function () {
            ...
            if ("contact_form" == e) {
                var a = $(this).attr("id"), o = $('.widget-element[lp-parent="' + a + '"]');
                o.attr("onclick", "onClick(this, event)"), o.css({cursor: "pointer"})
            }
    ...
    $(window).on("mousewheel", function (t) {
        ...
        var e = $(window).scrollTop(), i = $('.widget-section[lp-popup!="true"]');
    ...
    var a = new slider;
    a.playAllSlider(), a.playSliderControl(), (new GoogleMap).init(), (new LightBox).init();
    var o = $('.widget-section[lp-popup="true"]');
    o && o.length, o.on("scroll", function (t) {
        var e = $(this).find(".closePop");
        e && e.length > 0 && e.css({top: $(this).scrollTop() - 25 + "px"})
    }), $(window).on("scroll", function (t) {
        scrollTop = $(window).scrollTop();
        var e = $(window).scrollTop(), i = $('.widget-section[lp-popup = "true"]:visible'),
...
var stickyRun = function () {
    var t, e, i, n, a = $('[lp-sticky="1"]'), o = $(window).scrollTop(), r = $(window).outerHeight();
    a && a.length > 0 && a.each(function () {
    ...
    if ($('.widget-element[lp-type="button"][lp-parent="' + t.attr("id") + '"]').css({"z-index": 2}), t.attr("lp-vt-item") && t.attr("lp-vt-item").length > 0) for (var e = JSON.parse(t.attr("lp-vt-item")), i = 0; i < e.length; i++) {
        ...
        a.each(function () {
            var t = {id: $(this).attr("id"), top: parseFloat($(this).css("top"))};
            e.push(t)
        });
        for (i = 0; i < e.length; i++) for (var o = 0; o < e.length; o++) if (e[o].top > e[i].top) {
            var r = {};
            r.id = e[o].id, r.top = e[o].top, e[o].id = e[i].id, e[o].top = e[i].top, e[i].id = r.id, e[i].top = r.top
        }
        for (var l = 0; l < e.length; l++) if ($("#" + e[l].id).insertBefore(t.find(".widget-element").eq(l)), l == e.length - 1) return !0
    }
}, resetInputForm = function () {
    var t = $('.widget-element[lp-type="contact_form"]');
    t && t.length > 0 && t.each(function () {
        var t = $(this).attr("id");
        if ($('.widget-element[lp-type="button"][lp-parent="' + $(this).attr("id") + '"]').css({"z-index": 2}), $(this).attr("lp-vt-item") && $(this).attr("lp-vt-item").length > 0) for (var e = JSON.parse($(this).attr("lp-vt-item")), i = 0; i < e.length; i++) {
            var n = $("#" + t).find('.widget-content:eq(0) .widget-element[lp-type="item_form"]');
...
function ladinotify() {
    var t;
    (t = jQuery).fn.ladiNotify = function (e) {
        var i = t.extend({showDuration: 4e3, hideDuration: 6e3}, e),
            n = "https://static.ladipage.net/source/notify.svg", a = [{key: "gsx$title", className: ".nttitle"}, {
                key: "gsx$content",
                className: ".ntcontent"
            }, {key: "gsx$time", className: ".nttime"}, {key: "gsx$image", className: ".ntimage img"}];
        this.each(function () {
            var e = t(this), o = e.data("notify").sheetid;
            if (void 0 != o && 0 != o.trim().length) {
                ...
                switch (r) {
                    case"topleft":
                        e.css({top: "-100px", left: "0", right: "unset", bottom: "unset"});
                        break;
                    case"topright":
                        e.css({top: "-100px", right: "0", left: "unset", bottom: "unset"});
                        break;
                    case"bottomright":
                        e.css({bottom: "-100px", right: "0", left: "unset", top: "unset"});
                        break;
                    case"bottomleft":
                        e.css({bottom: "-100px", left: "0", right: "unset", top: "unset"});
                        break;
                    default:
            ...
            function s(o) {
                var s = i.showDuration, p = i.hideDuration + s;
                t(o).each(function () {
                    var t = this;
                    setTimeout(function () {
                        var i = Object.keys(t);
                        switch (a.forEach(function (a) {
                            if (-1 != i.indexOf(a.key)) if ("gsx$image" != a.key) e.find(a.className).text(t[a.key].$t); else {
                                var o = t[a.key].$t;
    ...
    }, $(".ladi-notify").ladiNotify()
}

$(document).ready(function () {
    var t = $(".ladi-wraper-page");
    t && t.length > 0 || $(".widget-section").wrapAll("<div class='ladi-wraper-page'/>"), (new ReponsivePage).init(), showPopupLoadPage(), $(".lp-close-fb-mes").unbind("click").click(function (t) {
        var e = $(this).parent();
        if (e && e.hasClass("widget-element")) {
            e.attr("id"), e.attr("id");
            $('style[id-style-mes="' + e.attr("id") + '"]').remove(), e.find(".widget-content").removeClass("fadeOutDown fadeInUp animated").addClass("fadeOutDown animated"), setTimeout(function () {
            }, 1e3), $(this).hide(), e.find(".lp-open-fb-mes").show()
        }
        ...
        if (t = $(this).attr("lp-endtime"), "time" == e && "timedown" != e) {
            ...
            if (i && i.length > 0) {
                var n = new Date(t).getTime(), a = (new Date).getTime(), o = Math.ceil((a - n) / 864e5);
                if (o > 0) {
                    var r = Math.ceil(o / parseFloat(i)) * i, l = new Date(t).setDate(new Date(t).getDate() + r);
        ...
        if ("true" == $(this).attr("lp-popup") && ($(t.target).hasClass("widget-section") || $(t.target).hasClass("ladi-widget-overlay") && "true" == $(t.target).parent().attr("lp-popup"))) {
            if ($(t.target).hasClass("ladi-widget-overlay") && "true" == $(t.target).parent().attr("lp-popup")) {
                ...
                t.pageX >= e.offset().left && t.pageX <= e.offset().left + e.outerWidth() && t.pageY >= e.offset().top && t.pageY <= e.offset().top + e.outerHeight() || ($(this).addClass("lp-hidepopup"), $(this).removeClass("lp-showpopup"), $(this).hide(), $("body").css({overflow: "auto"}).removeClass("body-fixed"))
            } else $(this).addClass("lp-hidepopup"), $(this).removeClass("lp-showpopup"), $(this).hide(), $(window).scrollTop(scrollTop), $("body").css({overflow: "auto"}).removeClass("body-fixed");
    ...
    e && e.length > 0 && e.each(function () {
        ...
        resetInputForm()
    }, 1e3), resetInputForm(), setTimeout(function () {
        try {
            var t = $(".ladi-wraper-page").attr("lp-tk");
